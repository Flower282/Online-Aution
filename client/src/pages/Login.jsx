              ...
              <form onSubmit={handleSubmit} data-aos="fade-up" data-aos-delay="200">
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-emerald-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-emerald-400 transition-all"
                    placeholder="••••••••"
                    required
                  />
                </div>
