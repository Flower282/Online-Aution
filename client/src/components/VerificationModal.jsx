                            ...
                            <>
                                ...
                                <div className="flex border-b border-gray-200 mb-6">
                                    ...
                                    >
                                        ...
                                        {phoneVerified && <CiCircleCheck className="w-5 h-5 text-cyan-500" />}
                                    </button>
                                    <button
                                    ...
                                    >
                                        ...
                                        {emailVerified && <CiCircleCheck className="w-5 h-5 text-cyan-500" />}
                                    </button>
                                    <button
                                    ...
                                    >
                                        ...
                                        {identityStatus === 'approved' && <CiCircleCheck className="w-5 h-5 text-cyan-500" />}
                                ...
                                {success && (
                                    <div className="mb-4 p-3 bg-cyan-50 border border-cyan-200 rounded-lg text-cyan-700 text-sm flex items-center gap-2">
                                            ...
                                            <form onSubmit={handlePhoneSubmit} className="space-y-4">
                                                ...
                                                <div className="flex gap-3">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`${isEditingPhone ? 'flex-1' : 'w-full'} py-3 bg-cyan-600 text-white rounded-lg font-medium hover:bg-cyan-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors`}
                                                    >
                                        ...
                                        {emailVerified ? (
                                            ...
                                            <form onSubmit={handleEmailSubmit} className="space-y-4">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full py-3 bg-cyan-600 text-white rounded-lg font-medium hover:bg-cyan-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                                                >
                                                    ...
                                                    <div className="md:col-span-2">
                                                        ...
                                                        <div className="relative">
                                                            ...
                                                            <input
                                                                ...
                                                                maxLength={12}
                                                                className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
                                                            />
                                                        </div>
                                                    </div>
